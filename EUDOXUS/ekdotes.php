...
<body>
    ...
    <div class="grid-container">
      <div>
        <a href="kataxwrhsh.php" class="myButton" >Καταχωρήση Συγγραμμάτων</a> </div>

      <div>
        <a href="#" class="myButton" >Ενημέρωση Συγγραμμάτων</a> </div>

       <div>
        <a href="ekdhelp.php" class="myButton" >Οδηγίες</a> </div>
