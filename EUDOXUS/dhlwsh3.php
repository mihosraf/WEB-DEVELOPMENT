...
<?php
    ...
    <body>
      ...
      <div style="text-align:center;">
          <form name= "semester" action="dhlwsh4.php" method="post">
            <select name="selectsemester" action="" >
              <?php
              $res=mysqli_query($db,"SELECT distinct semester from library where school = '$school' AND department = '$department' ");
